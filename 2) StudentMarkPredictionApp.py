...
app = Flask(__name__)
model = joblib.load(r"D:\Data Analytics\Jan 24\Student Mark Predictor Project Deployment\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
