# This is streamlit program of ml_salary.py(both are connected)
import streamlit as st
import pickle
import numpy as np

# Load the saved model(unpickling)
model = pickle.load(open(r'C:\Users\Anup\VS Code_DataAnalytics\ML_Salary\linear_regression_model.pkl', 'rb'))
# Above,rb stands for read binary
...
st.write("The model was trained using a dataset of salaries and years of experience,built model by anup bobde")
